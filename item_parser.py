...
def map_items_to_excel_dynamic(ws, parsed_items, item_rules, inv_sr_no=1, start_overall_sr=1, start_excel_row=2, default_invoice_no="", default_invoice_date="", pdf_text="", lut_kws="", paid_kws=""):
    ...
    # 🎯 यदि कमोडिटीज़ मिल गई हैं, तो लूप केवल उन कमोडिटीज़ की संख्या (जैसे 5) तक ही चलेगा ताकि वे सिर्फ एक बार आएं
    target_rows = extracted_commodities if extracted_commodities else parsed_items
    ...
    for item_idx in range(max_rows):
        ...
        # 🎯 BP और BQ कॉलम में कमोडिटीज़ भरना
