...
# --- 🚀 SIDEBAR PROFILE & EXCHANGE RATES SECTION ---
with st.sidebar:
    ...
    # Session State & Google Sheet Fetch for Exchange Rates[cite: 4]
...
def load_data_from_gsheet():
    """सीधे 'Shipper_JSON_Database' शीट से सारा डेटा JSON फॉर्मेट में लोड करता है[cite: 4]"""
    shipper_db = {}
